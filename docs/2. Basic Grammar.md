...
- 街を歩く。  
Walk through street. (Lit: Wwalk street)
...
- 空を飛ぶ。  
Fly through the sky. (Lit: Fly sky)

- 電車を降りる。  
Get off the train. (Lit: Descend train)

### 「に」

**「に」 is the target particle**. "Target" can mean any of the following:

1. physical location for *stative* verbs such as "to be" or "to live, to inhabit".
2. temporal location for numerical times
3. direction for motion verbs
4. indirect object (recipient of an action)

**1. Example of physical location for stative verbs**
...
**2. Example of temporal locations for numerical times**

Examples of "specific point in time"
...
**3. Examples of direction for motion verbs**
...
It indicates the recipient of an action. This is different from the 「を」 particle in which the verb does something **to** the direct object. With the 「に」 particle, the verb does something **toward** the word associated with the 「に」 particle. For example, the target of any motion verb is specified by the 「に」 particle.
