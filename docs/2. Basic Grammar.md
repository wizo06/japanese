...
In this type of sentence, the engine "B" is a verb. A *verb* is a word used to describe an action, such as: walk, talk, learn, think, etc. An example sentence is:

- Sakura walks.

In this sentence, "A" is "Sakura" (the main wagon) and "B" is "walks" (the thing Sakura does; the engine of the sentence). In Japanese, "Sakura" is 「さくら」, and "walk" is「歩く」(あるく). Lastly, we need one more thing to denote that "A" is *the main wagon*: the 「が」 particle. We will have a more in-depth explanation about particles in a later section. Particles are placed *after* the word that they mark. In this case, we want to mark 「さくら」 with the particle 「が」, so we place 「が」 after 「さくら」 like so: 「さくらが」. Putting everything together, to say **"Sakura walks"** in Japanese is:
...
Notice that the particle 「が」 is bundled with the "A" wagon in the table above. It is easier to visualize our train analogy by putting the "word-particle" pair in the same wagon.
...
This engine is used for expressing sentences like "A is B", where "B" is a **noun**. For example:

- Sakura is a Japanese person.

then "Japanese person" is telling us *what* "Sakura" is. We also need to express the word "**is**" from the sentence "Sakura **is** a Japanese person". To do that, we need the copula. In English, the copula is the word "be" and its conjugation "am/is/are". In Japanese, the hiragana 「だ」 is used as the copula (hence, we call this engine the だ-engine). So, to say "A is B" in Japanese, we attach 「だ」 at the end of "B". However, we only do so if "B" is a **noun**. In the previous example, "B" is "Japanese person" which is in fact a noun. So, the previous example in Japanese would be:

- さくらが日本人だ。

Main wagon "A" + が | だ-engine
:---: | :---:
さくらが | 日本人だ

*(As we learned in previous sections, the particle 「が」 is used to mark that 「さくら」 is "A".)*

To expand on the definition of what a "copula" is: a copula is a word that expresses a **one-way equality sign**.  In the previous example "Sakura is a Japanese person", we are essentially saying:
...
In the previous example, "A" is "Sakura", and "B" is "Japanese person". 

Some examples of "A is B" sentences in Japanese are:

Sentence in Japanese | Translation in English | Main wagon "A" + 「が」 | だ-engine
:---: | :---: | :---: | :---:
ボブが声優だ。 | Bob is a voice actor. | ボブが | 声優だ
私がアリスだ。 | I am Alice. | 私が | アリスだ
その人がアリスだ。 | That person is Alice. | その人が | アリスだ
私たちが学生だ。 | We are students. | 私たちが | 学生だ。
先生が女の人だ。 | Teacher is a woman. | 先生が | 女の人だ。
２が数字だ。 | 2 is a number. | ２が | 数字だ。
トムが医者だ。 | Tom is a doctor. | トムが | 医者だ。
日本人がアジア人だ。 | Japanese are Asians. | 日本人が | アジア人だ。

#### 3. い-engine | Adjectives

This engine is also used for expressing sentences like "A is B", but "B" is an **adjective**. We call this engine the い-engine because all adjectives in Japanese end with the kana 「い」. An example sentence is:

- ペンが赤い。

main wagon "A" + が | い-engine
:---: | :---:
ペンが | 赤い

*Pen is red*

As we learned in a previous section, we don't need the copula 「だ」 here because the 「い」 part of the adjective already serves the function of a copula. In other words, 「赤い」 doesn't mean "red", it means "is red". To re-emphasize, if we say:
...
In this type of sentence, the engine "B" is expressing *what* "A" is. That "*what*" is a *noun*. A noun is a word used to identify a class of people, places, or things, such as: pencil, home, food, friend, person, Japanese person, American person, etc. An example sentence is: 

- Sakura is an American person

"A" is "Sakura", and "B" is "is American person". In Japanese, "American person" is 「アメリカ人」(アメリカじん). Once again, we need the 「が」 particle to denote that "Sakura" is the main wagon "A". Lastly, we need to express the word "**is**" from "Sakura **is** an American person" in Japanese. To express "is" in Japanese, we say: 「だ」. This 「だ」 is placed *after* 「アメリカ人」. Putting everything together, to say **"Sakura is American"** in Japanese is:
...
The English word "is", and the equivalent Japanese word 「だ」, is called a **copula**. A copula is a word that equates one thing to another. It is a **one-way** equality sign. In other words, the sentence 「さくらがアメリカ人だ」 means "Sakura" is equal to "American", but "American" does not necessarily equal to "Sakura". In other words: 

- "Sakura belongs to the set of American people." 
- "Sakura is an American person" but "an American person is not necessarily Sakura."
- "Sakura is American" but "not all Americans are Sakura." 

We will have a more in-depth look at the copula in a later section.

#### 2.2. A is B (adjective)

In this type of sentence, the engine "B" is also expressing *what* "A" is. The difference is that the *what* part is an *adjective*. An adjective is a word that names an attribute that modifies or describes a noun, such as: sad, angry, happy, pretty, tall, difficult, easy, hot, cold, etc. In Japanese, all adjectives end with the kana 「い」.

Let's look at an example sentence: 

- Sakura is kind 

"A" is "Sakura", and "B" is "is kind". In Japanese, "kind" is 「優しい」(やさしい). Once again, we need the 「が」 particle for the main wagon "A". Putting everything together, to say **"Sakura is kind"** is:
...
Why is 「だ」 missing? Because 「優しい」 doesn't mean "kind", it means "is kind". The copula is built into the adjective, which is the 「い」 part of the adjective. If we say:

!!! failure "Incorrect"
    さくらが優しいだ。

then it would mean "Sakura is kind is", which makes no sense.
